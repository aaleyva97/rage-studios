...
@Component({
  selector: 'app-admin-credits-assign',
  imports: [
    FormsModule,
    ButtonModule,
    CardModule,
  ...
  templateUrl: './admin-credits-assign.html',
  styleUrl: './admin-credits-assign.scss'
})
export class AdminCreditsAssign implements OnInit {
