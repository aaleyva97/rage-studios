-- ============================================================================
-- Retornar bed_numbers en checkin_scan_pass
--
-- Modifica checkin_scan_pass() para retornar 'bed_numbers' en las respuestas
-- exitosas (OK) y ya marcadas (ALREADY_CHECKED_IN), permitiendo mostrar el 
-- número de reformer asignado en los pop-ups de confirmación de recepción.
-- ============================================================================
